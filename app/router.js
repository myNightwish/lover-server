...
module.exports = app => {
  ...
  router.get('/api/empathy/current-task', authWx, controller.empathy.getCurrentTask);
  router.get('/api/empathy/task-history', authWx, controller.empathy.getTaskHistory);
